...
function Update_ForgetPassword() {
      ...
      {!isForget ? (
        <>
          <div className="flex items-center mb-6 h-10 bg-gray-300 px-10">
            <p className="font-semibold text-gray-600">Update Password</p>
          </div>
          <form
        ...
        <>
          <div className="flex items-center mb-6 h-10 bg-gray-300 px-10">
            <p className="font-semibold text-gray-600">Forget Password</p>
          </div>
          <div className="flex justify-between items-start p-10">
            {verify ? newPassword : sendOtp}
            <div>
              <button
                type="button"
                className="py-2    mr-6  px-3 text-xs font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
